...
export default function NotFoundId () {
    ...
    <div className="space-y-2 text-center">
      ...
      <p className="text-2xl font-medium text-muted-foreground sm:text-3xl">Poject not found</p>
      <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
        The Project with the id you are looking for does not exist or has been moved.
      </p>
    </div>
    <Link
      href="/"
